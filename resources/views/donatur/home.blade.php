...
<head>
    ...
    <title>Home</title>
    <link rel="stylesheet" href="{{ asset('css/donatur/home.css') }}" />
</head>
...
<body>
            ...
            <div class="showcase-area">
                <div class="container">
                    <div class="left">
                        ...
                        <div class="cta">
                            <a href="{{ route('donatur-donasi') }}" class="btn btn-donasi">Donasi Sekarang</a>
                        </div>
                    </div>
    ...
    <script src="{{ asset('js/donatur/home.js') }}"></script>
</body>
